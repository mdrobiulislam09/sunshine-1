...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer footer-center p-10 bg-collor text-base-content rounded">
                ...
                <div>
                    <p className='copy'>Copyright © 2023 - All right reserved by ACME Industries Ltd</p>
                </div>
            </footer>
        </div>
    );
